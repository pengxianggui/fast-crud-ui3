...
:::tip
1. FastTableOption必须配合[FastTable](/latest/comp/fast-table)组件使用
2. `module`配置项是唯一必须提供的配置项
:::
...
| pageUrl               | 分页接口地址。如需自定义则配置                                            | `String`                                                  | `${module}/page`                                                                                    |
| listUrl               | 列表接口地址。如需自定义则配置                                            | `String`                                                  | `${module}/list`                                                                                    |
| insertUrl             | 新增接口地址。如需自定义则配置                                            | `String`                                                  | `${module}/insert`                                                                                  |
| batchInsertUrl        | 批量新增接口地址。如需自定义则配置                                          | `String`                                                  | `${module}/insert/batch`                                                                            |
| updateUrl             | 更新接口地址。如需自定义则配置                                            | `String`                                                  | `${module}/update`                                                                                  |
| batchUpdateUrl        | 批量更新接口地址。如需自定义则配置                                          | `String`                                                  | `${module}/update/batch`                                                                            |
| deleteUrl             | 删除接口地址。如需自定义则配置                                            | `String`                                                  | `${module}/delete`                                                                                  |
| batchDeleteUrl        | 批量删除接口地址。如需自定义则配置                                          | `String`                                                  | `${module}/delete/batch`                                                                            |
| uploadUrl             | 上传接口地址。如需自定义则配置                                            | `String`                                                  | `${module}/upload`                                                                                  |
| exportUrl             | 导出接口地址。如需自定义则配置                                            | `String`                                                  | `${module}/export`                                                                                  |
...
|formLayout|弹窗表单的字段布局, 例如: `"id,avatarUrl,name\|age\|sex,createTime`,则表示第一行是id和avatarUrl各占50%,第二行是name、age、sex各占33.3%, 第三行是createTime独占一行| `String` | - |
